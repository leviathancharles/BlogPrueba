...
class __TwigTemplate_9c9de8b8a3ce3186199abe21a8422425f717632206fc792862443063d57c7cbf extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"container\">
  <div class=\"form-group\">
        <div class = \"row\">
            <div class = \"col-md-12 \"><h1 class=\"display-3\">Formulario de Contacto</h1></div>
        ...
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 16, $this->source); })()), "flashes", [0 => "mensaje"], "method", false, false, false, 16));
...
";
    ...
    {
        return array (  125 => 21,  116 => 18,  113 => 17,  109 => 16,  105 => 15,  101 => 14,  97 => 13,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% endblock %}
", "contacto/index.html.twig", "C:\\xampp\\htdocs\\symfony\\blog-symfony\\templates\\contacto\\index.html.twig");
    }
}
